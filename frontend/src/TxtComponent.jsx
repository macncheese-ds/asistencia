...
function TxtComponent({ onClose }) {
  const [mode, setMode] = useState(null); // 'edit' or 'view'
                    ...
                    <div className="space-y-2">
                      {adminEmpleadoData.map((record) => {
                        ...
                        return (
                          <div
                            key={record.id}
                            className="flex justify-between items-center bg-gray-800 p-4 rounded border border-gray-700 hover:border-gray-600 transition"
                          >
                            ...
                            <button
                              ...
                              className="bg-red-900 hover:bg-red-800 text-red-200 px-4 py-2 rounded transition"
                            >
                              Eliminar
                            </button>
                          </div>
